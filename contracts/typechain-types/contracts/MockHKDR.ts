...
export interface MockHKDRInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "FAUCET_AMOUNT"
      | "FAUCET_COOLDOWN"
...
export interface MockHKDR extends BaseContract {
  connect(runner?: ContractRunner | null): MockHKDR;
  waitForDeployment(): Promise<this>;

  interface: MockHKDRInterface;
