...
export interface MockPHPCInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface MockPHPC extends BaseContract {
  connect(runner?: ContractRunner | null): MockPHPC;
  waitForDeployment(): Promise<this>;

  interface: MockPHPCInterface;
